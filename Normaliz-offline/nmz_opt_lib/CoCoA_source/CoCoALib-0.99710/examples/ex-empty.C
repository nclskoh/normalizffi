...
int main()
{
  ...
  // Uncomment these lines if you want a "nice" message when an interrupt is recognized
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/examples/ex-empty.C,v 1.15 2020/01/09 13:32:48 abbott Exp $
// $Log: ex-empty.C,v $
