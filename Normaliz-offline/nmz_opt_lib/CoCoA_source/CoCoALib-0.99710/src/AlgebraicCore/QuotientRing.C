...
namespace CoCoA
{
  ...
  const QuotientRingBase* QuotientRingPtr(const ring& R, const char* const FnName)
  {
    ...
    if (ptr == nullptr) CoCoA_ERROR(ERR::NotQuotientRing, FnName);
    return ptr;
  }
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/QuotientRing.C,v 1.78 2020/02/18 11:27:30 abbott Exp $
