  ...
  void GeneralPPMonoidHomImpl::myApply(PPMonoidElemRawPtr image, PPMonoidElemConstRawPtr arg) const
  {
    ...
    for (long i=0; i < N; ++i)
    {
      if (/*IsPPMonoidOv(myCodomain)&&*/
        ...
        if (exp[i] >= 32749)
          CoCoA_ERROR(ERR::ExpTooBig, "GeneralPPMonoidHomImpl::myApply");
...
// RCS header/log
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/PPMonoidHom.C,v 1.10 2020/02/11 16:56:41 abbott Exp $
// $Log: PPMonoidHom.C,v $
