...
*/
  ...
  { CoCoA_ERROR(ERR::NYI, "RingExtAlgImpl::IdealImpl::myTestIsMaximal()"); }


  void RingExtAlgImpl::IdealImpl::myTestIsPrimary() const
  { CoCoA_ERROR(ERR::NYI, "RingExtAlgImpl::IdealImpl::myTestIsPrimary()"); }


  void RingExtAlgImpl::IdealImpl::myTestIsPrime() const
  { CoCoA_ERROR(ERR::NYI, "RingExtAlgImpl::IdealImpl::myTestIsPrime()"); }


  void RingExtAlgImpl::IdealImpl::myTestIsRadical() const
  { CoCoA_ERROR(ERR::NYI, "RingExtAlgImpl::IdealImpl::myTestIsRadical()"); }
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/RingExtAlg.C,v 1.13 2020/02/12 09:01:47 bigatti Exp $
// $Log: RingExtAlg.C,v $
