...
//    return myImpl.myExport(import(rawx)) < 0;
  ...
  RingHom RingFqLogImpl::myCompose(const RingHom& phi, const RingHom& theta) const
  {
    ...
    CoCoA_ERROR(ERR::NYI, "RingFqLogImpl::myCompose");
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/RingFqLog.C,v 1.14 2020/02/11 16:56:41 abbott Exp $
// $Log: RingFqLog.C,v $
