...
namespace CoCoA
{
  ...
  const RingTwinFloatBase* RingTwinFloatPtr(const ring& R, const char* const FnName)
  {
    ...
    if (ptr == nullptr) CoCoA_ERROR(ERR::NotRingTwinFloat, FnName);
    return ptr;
  }
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/RingTwinFloat.C,v 1.56 2020/02/11 16:56:42 abbott Exp $
