...
// Special case code; should be a bit more efficient that general case -- is it really worth it???
  ...
  namespace  {  // anonymous
    ...
    {
      if (IndetNames.empty())
        CoCoA_ERROR(ERR::Empty, "NewPolyRing_DMPII pseudo ctor");
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/RingDistrMPolyInlFpPP.C,v 1.49 2020/01/09 16:41:10 bigatti Exp $
