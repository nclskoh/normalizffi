...
//BUG SHOULD NEVER GET HERE --> restructure code!
  ...
  {
    if (!IsRectangular(VV))
      CoCoA_ERROR(ERR::BadMatrixSize, "NewDenseMatTranspose()");
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/DenseMatrix.C,v 1.42 2020/02/28 08:55:14 abbott Exp $
// $Log: DenseMatrix.C,v $
