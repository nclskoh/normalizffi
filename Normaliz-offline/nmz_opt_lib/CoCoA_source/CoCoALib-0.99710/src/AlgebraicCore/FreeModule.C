...
namespace CoCoA
{
  ...
  const FreeModuleBase* FreeModulePtr(const module& M, const char* const FnName)
  {
    ...
    if (ptr == nullptr) CoCoA_ERROR(ERR::NotFreeModule, FnName);
    return ptr;
  }
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/FreeModule.C,v 1.35 2020/02/11 16:56:40 abbott Exp $
// $Log: FreeModule.C,v $
