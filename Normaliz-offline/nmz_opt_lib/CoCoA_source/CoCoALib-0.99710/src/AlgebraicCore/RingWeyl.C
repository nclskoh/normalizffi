...
*/
  ...
  { CoCoA_ERROR(ERR::NYI, "RingWeylImpl::IdealImpl::myTestIsMaximal()"); }


  void RingWeylImpl::IdealImpl::myTestIsPrimary() const
  { CoCoA_ERROR(ERR::NYI, "RingWeylImpl::IdealImpl::myTestIsPrimary()"); }


  void RingWeylImpl::IdealImpl::myTestIsPrime() const
  { CoCoA_ERROR(ERR::NYI, "RingWeylImpl::IdealImpl::myTestIsPrime()"); }


  void RingWeylImpl::IdealImpl::myTestIsRadical() const
  { CoCoA_ERROR(ERR::NYI, "RingWeylImpl::IdealImpl::myTestIsRadical()"); }
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/RingWeyl.C,v 1.66 2020/02/12 09:01:47 bigatti Exp $
// $Log: RingWeyl.C,v $
