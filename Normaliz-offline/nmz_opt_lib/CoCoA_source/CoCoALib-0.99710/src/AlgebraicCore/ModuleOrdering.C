...
namespace CoCoA
{
  ...
  { CoCoA_ERROR(ERR::NYI, "PosnOrdCtor with shifts"); return operator()(PPO,0); }
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/ModuleOrdering.C,v 1.8 2020/02/11 16:56:41 abbott Exp $
