...
namespace CoCoA
{
  ...
  VerificationLevel::VerificationLevel(long vl):
      myLevel(vl)
  {
    if (vl < 0 || vl > 1000)
      CoCoA_ERROR(ERR::OutOfRange, "VerificationLevel ctor");
  }
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/VerificationLevel.C,v 1.4 2020/02/11 16:12:20 abbott Exp $
