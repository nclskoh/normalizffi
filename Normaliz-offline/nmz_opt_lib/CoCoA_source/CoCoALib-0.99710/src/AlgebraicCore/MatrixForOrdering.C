...
namespace CoCoA
{
  ...
  bool IsTermOrdering(const ConstMatrixView& M)
  {
    if (NumCols(M) != NumRows(M))
      CoCoA_ERROR(ERR::NotSquareMatrix, "IsTermOrdering");
...
// $Header: /Volumes/Home_1/cocoa/cvs-repository/CoCoALib-0.99/src/AlgebraicCore/MatrixForOrdering.C,v 1.43 2020/02/13 10:14:00 abbott Exp $
